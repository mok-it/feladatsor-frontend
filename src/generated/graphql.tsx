...
export type CreateExerciseSheetCommentInput = {
  comment: Scalars["String"]["input"];
  contributorIds?: InputMaybe<Array<Scalars["ID"]["input"]>>;
  exerciseOnExerciseSheetItemId?: InputMaybe<Scalars["ID"]["input"]>;
  exerciseSheetId?: InputMaybe<Scalars["ID"]["input"]>;
  exerciseSheetItemId?: InputMaybe<Scalars["ID"]["input"]>;
};
...
export type ExerciseCheckRole = "EXAMINER" | "LECTOR" | "PROFESSIONAL";

export type ExerciseCheckType = "CHANGE_REQUIRED" | "GOOD" | "TO_DELETE";
...
export type ExerciseSheet = {
  ...
  comments: Array<ExerciseSheetComment>;
  createdAt: Scalars["String"]["output"];
  createdBy: User;
  id: Scalars["ID"]["output"];
  maxExercisesPerLevel: Array<Scalars["Int"]["output"]>;
  name: Scalars["String"]["output"];
...
export type ExerciseSheetComment = {
  __typename: "ExerciseSheetComment";
  comment: Scalars["String"]["output"];
  createdAt: Scalars["String"]["output"];
  exerciseOnExerciseSheetItemId?: Maybe<Scalars["ID"]["output"]>;
  exerciseSheetId?: Maybe<Scalars["ID"]["output"]>;
  exerciseSheetItemId?: Maybe<Scalars["ID"]["output"]>;
  id: Scalars["ID"]["output"];
...
export type ExerciseSheetInput = {
  maxExercisesPerLevel?: InputMaybe<Array<Scalars["Int"]["input"]>>;
...
export type ExerciseSheetStatus = "APPROVED" | "CREATED" | "DELETED" | "DRAFT";

export type ExerciseStatus = "APPROVED" | "CREATED" | "DELETED" | "DRAFT";
...
export type Mutation = {
  ...
  createExerciseSheetComment: ExerciseSheetComment;
...
export type Query = {
  ...
  exerciseSheetComments: Array<ExerciseSheetComment>;
...
export type QueryExerciseSheetCommentsArgs = {
  sheetId: Scalars["ID"]["input"];
};

export type QueryExerciseSheetsArgs = {
...
export type ChangePermissionsMutation = {
  __typename: "Mutation";
  changePermissions: { __typename: "User"; id: string; name: string };
};
...
export type CloneExerciseToNewMutation = {
  __typename: "Mutation";
  cloneExerciseToNew: { __typename: "Exercise"; id: string };
};
...
export type CommentsByExerciseQuery = {
  __typename: "Query";
  commentsByExercise: Array<{
    __typename: "ExerciseComment";
    id: string;
    comment: string;
    createdAt: string;
...
export type CreateExerciseMutation = {
  __typename: "Mutation";
  createExercise: { __typename: "Exercise"; id: string };
};
...
export type CreateExerciseCheckMutation = {
  __typename: "Mutation";
  createExerciseCheck: {
    __typename: "ExerciseCheck";
    id: string;
...
export type CreateExerciseCommentMutation = {
  __typename: "Mutation";
...
export type CreateExerciseSheetMutation = {
  __typename: "Mutation";
  createExerciseSheet: {
    __typename: "ExerciseSheet";
    id: string;
...
export type CreateExerciseTagMutation = {
  __typename: "Mutation";
  createExerciseTag: { __typename: "ExerciseTag"; id: string };
};
...
export type DeleteExcelExportMutation = {
  __typename: "Mutation";
  deleteExcelExport: {
    __typename: "ExcelExportDeleteResult";
    success: boolean;
...
export type DeleteExerciseCommentMutation = {
  __typename: "Mutation";
  deleteExerciseComment: { __typename: "ExerciseComment"; id: string };
};
...
export type DeleteExerciseSheetMutation = {
  __typename: "Mutation";
  deleteExerciseSheet: boolean;
};
...
export type DeleteExerciseTagMutation = {
  __typename: "Mutation";
  deleteExerciseTag: boolean;
};
...
export type SelectExerciseQuery = {
  ...
  exercise?: {
    ...
    status: ExerciseStatus;
    description: string;
    solutionOptions: Array<string>;
    solution: string;
    solveIdea?: string | null;
    source?: string | null;
    createdAt: string;
    helpingQuestions: Array<string>;
    alert?: {
      __typename: "ExerciseAlert";
      description: string;
      severity: AlertSeverity;
    ...
    sameLogicExerciseGroup?: {
      ...
      exercises: Array<{
        ...
        exerciseImage?: { __typename: "Image"; url: string } | null;
    ...
    exerciseImage?: { __typename: "Image"; id: string; url: string } | null;
    solutionImage?: { __typename: "Image"; id: string; url: string } | null;
    createdBy: {
      __typename: "User";
      id: string;
      name: string;
    ...
    solveIdeaImage?: { __typename: "Image"; id: string; url: string } | null;
    tags: Array<{ __typename: "Tag"; id: string; name: string }>;
    difficulty: Array<{
      __typename: "ExerciseDifficulty";
      ageGroup: ExerciseAgeGroup;
...
export type ExerciseHistoryByExerciseQuery = {
  __typename: "Query";
  exerciseHistoryByExercise: Array<{
    __typename: "ExerciseHistory";
    id: string;
    field: string;
    fieldType: ExerciseHistoryFieldType;
    ...
    updatedAt: string;
    oldValue?:
      | { __typename: "HistoryStringValue"; value: string }
      | {
          __typename: "HistoryTagArray";
          tags: Array<{ __typename: "ExerciseTag"; id: string; name: string }>;
        }
      | {
          __typename: "HistoryUserArray";
          users: Array<{
...
export type ExerciseSheetQuery = {
  __typename: "Query";
  exerciseSheet?: {
    __typename: "ExerciseSheet";
    id: string;
...
export type ExerciseSheetsQuery = {
  __typename: "Query";
...
export type ExerciseTagsQuery = {
  __typename: "Query";
  flatExerciseTags: Array<{
    __typename: "ExerciseTag";
    id: string;
    name: string;
    exerciseCount: number;
    children: Array<{ __typename: "ExerciseTag"; id: string }>;
  }>;
};
...
export type SelectExercisesQuery = {
  __typename: "Query";
  exercises: Array<{
    __typename: "Exercise";
    id: string;
...
export type ExportExcelMutation = {
  __typename: "Mutation";
  exportExcel?: { __typename: "ExportResult"; id: string; url: string } | null;
};

export type FlatExerciseTagsQueryVariables = Exact<{ [key: string]: never }>;

export type FlatExerciseTagsQuery = {
  __typename: "Query";
  flatExerciseTags: Array<{
    __typename: "ExerciseTag";
    id: string;
...
export type ExerciseCheckFragment = {
  __typename: "ExerciseCheck";
  id: string;
  type: ExerciseCheckType;
  createdAt: string;
...
export type ExerciseCommentFragment = {
  __typename: "ExerciseComment";
  id: string;
  comment: string;
  createdAt: string;
...
export type ExerciseListElemFragment = {
  __typename: "Exercise";
  id: string;
  description: string;
  status: ExerciseStatus;
...
export type SameLogicExerciseFragment = {
  __typename: "Exercise";
  id: string;
  description: string;
  createdAt: string;
...
export type ListExcelExportsQuery = {
  __typename: "Query";
  listExcelExports: Array<{
    __typename: "ExportResult";
    id: string;
    fileName: string;
    fileSize: string;
...
export type RegisterMutation = {
  __typename: "Mutation";
  register: { __typename: "User"; id: string; userName: string };
};
...
export type UpdateExerciseMutation = {
  __typename: "Mutation";
  updateExercise: { __typename: "Exercise"; id: string };
};
...
export type UpdateExerciseCommentMutation = {
  __typename: "Mutation";
...
export type UpdateExerciseSheetMutation = {
  __typename: "Mutation";
  updateExerciseSheet: { __typename: "ExerciseSheet"; id: string };
};
...
export type UpdateExerciseTagMutation = {
  __typename: "Mutation";
  updateExerciseTag: { __typename: "ExerciseTag"; id: string };
};
...
export type UserExerciseFragment = {
  __typename: "Exercise";
  id: string;
  description: string;
  createdAt: string;
...
export type UserCommentFragment = {
  ...
  comment: string;
  createdAt: string;
  exercise: { __typename: "Exercise"; id: string; description: string };
};
...
export type SelectUserExercisesQuery = {
  __typename: "Query";
  user?: {
    __typename: "User";
    id: string;
...
export type SelectUserCommentsQuery = {
  __typename: "Query";
  user?: {
    __typename: "User";
    id: string;
...
export type VoteOnDeveloperMutation = {
  __typename: "Mutation";
  voteOnDeveloper?: { __typename: "Developer"; id: string } | null;
};
...
`;
export type ChangePermissionsMutationFn = Apollo.MutationFunction<
  ChangePermissionsMutation,
 ...
 * });
 */
export function useChangePermissionsMutation(
  ...
  return Apollo.useMutation<
    ChangePermissionsMutation,
    ChangePermissionsMutationVariables
  >(ChangePermissionsDocument, options);
}
export type ChangePermissionsMutationHookResult = ReturnType<
  typeof useChangePermissionsMutation
>;
export type ChangePermissionsMutationResult =
  Apollo.MutationResult<ChangePermissionsMutation>;
export type ChangePermissionsMutationOptions = Apollo.BaseMutationOptions<
  ChangePermissionsMutation,
  ChangePermissionsMutationVariables
>;
...
`;
export type CloneExerciseToNewMutationFn = Apollo.MutationFunction<
  CloneExerciseToNewMutation,
  CloneExerciseToNewMutationVariables
>;
 ...
 * });
 */
export function useCloneExerciseToNewMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CloneExerciseToNewMutation,
    CloneExerciseToNewMutationVariables
  >,
  ...
  return Apollo.useMutation<
    CloneExerciseToNewMutation,
    CloneExerciseToNewMutationVariables
  >(CloneExerciseToNewDocument, options);
}
export type CloneExerciseToNewMutationHookResult = ReturnType<
  typeof useCloneExerciseToNewMutation
>;
export type CloneExerciseToNewMutationResult =
  Apollo.MutationResult<CloneExerciseToNewMutation>;
export type CloneExerciseToNewMutationOptions = Apollo.BaseMutationOptions<
  CloneExerciseToNewMutation,
  CloneExerciseToNewMutationVariables
>;
 ...
 * });
 */
export function useCommentsByExerciseQuery(
  baseOptions: Apollo.QueryHookOptions<
    CommentsByExerciseQuery,
    CommentsByExerciseQueryVariables
  > &
    (
      | { variables: CommentsByExerciseQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    CommentsByExerciseQuery,
    CommentsByExerciseQueryVariables
  >(CommentsByExerciseDocument, options);
}
export function useCommentsByExerciseLazyQuery(
...
export function useCommentsByExerciseSuspenseQuery(
...
export type CommentsByExerciseQueryHookResult = ReturnType<
  typeof useCommentsByExerciseQuery
>;
export type CommentsByExerciseLazyQueryHookResult = ReturnType<
  typeof useCommentsByExerciseLazyQuery
>;
export type CommentsByExerciseSuspenseQueryHookResult = ReturnType<
  typeof useCommentsByExerciseSuspenseQuery
>;
export type CommentsByExerciseQueryResult = Apollo.QueryResult<
  CommentsByExerciseQuery,
  CommentsByExerciseQueryVariables
>;
...
export const CreateExerciseCheckDocument = gql`
  ...
  ${ExerciseCheckFragmentDoc}
`;
export type CreateExerciseCheckMutationFn = Apollo.MutationFunction<
  CreateExerciseCheckMutation,
  CreateExerciseCheckMutationVariables
>;
 ...
 * });
 */
export function useCreateExerciseCheckMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CreateExerciseCheckMutation,
    CreateExerciseCheckMutationVariables
  >,
  ...
  return Apollo.useMutation<
    CreateExerciseCheckMutation,
    CreateExerciseCheckMutationVariables
  >(CreateExerciseCheckDocument, options);
}
export type CreateExerciseCheckMutationHookResult = ReturnType<
  typeof useCreateExerciseCheckMutation
>;
export type CreateExerciseCheckMutationResult =
  Apollo.MutationResult<CreateExerciseCheckMutation>;
export type CreateExerciseCheckMutationOptions = Apollo.BaseMutationOptions<
  CreateExerciseCheckMutation,
  CreateExerciseCheckMutationVariables
>;
export const CreateExerciseCommentDocument = gql`
  ...
  ${ExerciseCommentFragmentDoc}
`;
export type CreateExerciseCommentMutationFn = Apollo.MutationFunction<
  CreateExerciseCommentMutation,
  CreateExerciseCommentMutationVariables
>;
 ...
 * });
 */
export function useCreateExerciseCommentMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CreateExerciseCommentMutation,
    CreateExerciseCommentMutationVariables
  >,
  ...
  return Apollo.useMutation<
    CreateExerciseCommentMutation,
    CreateExerciseCommentMutationVariables
  >(CreateExerciseCommentDocument, options);
}
export type CreateExerciseCommentMutationHookResult = ReturnType<
  typeof useCreateExerciseCommentMutation
>;
export type CreateExerciseCommentMutationResult =
  Apollo.MutationResult<CreateExerciseCommentMutation>;
export type CreateExerciseCommentMutationOptions = Apollo.BaseMutationOptions<
  CreateExerciseCommentMutation,
  CreateExerciseCommentMutationVariables
>;
...
`;
export type CreateExerciseSheetMutationFn = Apollo.MutationFunction<
  CreateExerciseSheetMutation,
  CreateExerciseSheetMutationVariables
>;
 ...
 * });
 */
export function useCreateExerciseSheetMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CreateExerciseSheetMutation,
    CreateExerciseSheetMutationVariables
  >,
  ...
  return Apollo.useMutation<
    CreateExerciseSheetMutation,
    CreateExerciseSheetMutationVariables
  >(CreateExerciseSheetDocument, options);
}
export type CreateExerciseSheetMutationHookResult = ReturnType<
  typeof useCreateExerciseSheetMutation
>;
export type CreateExerciseSheetMutationResult =
  Apollo.MutationResult<CreateExerciseSheetMutation>;
export type CreateExerciseSheetMutationOptions = Apollo.BaseMutationOptions<
  CreateExerciseSheetMutation,
  CreateExerciseSheetMutationVariables
>;
...
`;
export type CreateExerciseTagMutationFn = Apollo.MutationFunction<
  CreateExerciseTagMutation,
  CreateExerciseTagMutationVariables
>;
 ...
 * });
 */
export function useCreateExerciseTagMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CreateExerciseTagMutation,
    CreateExerciseTagMutationVariables
  >,
  ...
  return Apollo.useMutation<
    CreateExerciseTagMutation,
    CreateExerciseTagMutationVariables
  >(CreateExerciseTagDocument, options);
}
export type CreateExerciseTagMutationHookResult = ReturnType<
  typeof useCreateExerciseTagMutation
>;
export type CreateExerciseTagMutationResult =
  Apollo.MutationResult<CreateExerciseTagMutation>;
export type CreateExerciseTagMutationOptions = Apollo.BaseMutationOptions<
  CreateExerciseTagMutation,
  CreateExerciseTagMutationVariables
>;
...
`;
export type DeleteExcelExportMutationFn = Apollo.MutationFunction<
  DeleteExcelExportMutation,
  DeleteExcelExportMutationVariables
>;
 ...
 * });
 */
export function useDeleteExcelExportMutation(
  baseOptions?: Apollo.MutationHookOptions<
    DeleteExcelExportMutation,
    DeleteExcelExportMutationVariables
  >,
  ...
  return Apollo.useMutation<
    DeleteExcelExportMutation,
    DeleteExcelExportMutationVariables
  >(DeleteExcelExportDocument, options);
}
export type DeleteExcelExportMutationHookResult = ReturnType<
  typeof useDeleteExcelExportMutation
>;
export type DeleteExcelExportMutationResult =
  Apollo.MutationResult<DeleteExcelExportMutation>;
export type DeleteExcelExportMutationOptions = Apollo.BaseMutationOptions<
  DeleteExcelExportMutation,
  DeleteExcelExportMutationVariables
>;
...
`;
export type DeleteExerciseCommentMutationFn = Apollo.MutationFunction<
  DeleteExerciseCommentMutation,
  DeleteExerciseCommentMutationVariables
>;
 ...
 * });
 */
export function useDeleteExerciseCommentMutation(
  baseOptions?: Apollo.MutationHookOptions<
    DeleteExerciseCommentMutation,
    DeleteExerciseCommentMutationVariables
  >,
  ...
  return Apollo.useMutation<
    DeleteExerciseCommentMutation,
    DeleteExerciseCommentMutationVariables
  >(DeleteExerciseCommentDocument, options);
}
export type DeleteExerciseCommentMutationHookResult = ReturnType<
  typeof useDeleteExerciseCommentMutation
>;
export type DeleteExerciseCommentMutationResult =
  Apollo.MutationResult<DeleteExerciseCommentMutation>;
export type DeleteExerciseCommentMutationOptions = Apollo.BaseMutationOptions<
  DeleteExerciseCommentMutation,
  DeleteExerciseCommentMutationVariables
>;
...
`;
export type DeleteExerciseSheetMutationFn = Apollo.MutationFunction<
  DeleteExerciseSheetMutation,
  DeleteExerciseSheetMutationVariables
>;
 ...
 * });
 */
export function useDeleteExerciseSheetMutation(
  baseOptions?: Apollo.MutationHookOptions<
    DeleteExerciseSheetMutation,
    DeleteExerciseSheetMutationVariables
  >,
  ...
  return Apollo.useMutation<
    DeleteExerciseSheetMutation,
    DeleteExerciseSheetMutationVariables
  >(DeleteExerciseSheetDocument, options);
}
export type DeleteExerciseSheetMutationHookResult = ReturnType<
  typeof useDeleteExerciseSheetMutation
>;
export type DeleteExerciseSheetMutationResult =
  Apollo.MutationResult<DeleteExerciseSheetMutation>;
export type DeleteExerciseSheetMutationOptions = Apollo.BaseMutationOptions<
  DeleteExerciseSheetMutation,
  DeleteExerciseSheetMutationVariables
>;
...
`;
export type DeleteExerciseTagMutationFn = Apollo.MutationFunction<
  DeleteExerciseTagMutation,
  DeleteExerciseTagMutationVariables
>;
 ...
 * });
 */
export function useDeleteExerciseTagMutation(
  baseOptions?: Apollo.MutationHookOptions<
    DeleteExerciseTagMutation,
    DeleteExerciseTagMutationVariables
  >,
  ...
  return Apollo.useMutation<
    DeleteExerciseTagMutation,
    DeleteExerciseTagMutationVariables
  >(DeleteExerciseTagDocument, options);
}
export type DeleteExerciseTagMutationHookResult = ReturnType<
  typeof useDeleteExerciseTagMutation
>;
export type DeleteExerciseTagMutationResult =
  Apollo.MutationResult<DeleteExerciseTagMutation>;
export type DeleteExerciseTagMutationOptions = Apollo.BaseMutationOptions<
  DeleteExerciseTagMutation,
  DeleteExerciseTagMutationVariables
>;
 ...
 * });
 */
export function useSelectExerciseQuery(
  baseOptions: Apollo.QueryHookOptions<
    SelectExerciseQuery,
    SelectExerciseQueryVariables
  > &
    (
      | { variables: SelectExerciseQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<SelectExerciseQuery, SelectExerciseQueryVariables>(
    SelectExerciseDocument,
    options,
  );
}
export function useSelectExerciseLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SelectExerciseQuery,
    SelectExerciseQueryVariables
  >,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<SelectExerciseQuery, SelectExerciseQueryVariables>(
    SelectExerciseDocument,
    options,
  );
}
export function useSelectExerciseSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    SelectExerciseQuery,
    SelectExerciseQueryVariables
  >,
  ...
  return Apollo.useSuspenseQuery<
    SelectExerciseQuery,
    SelectExerciseQueryVariables
  >(SelectExerciseDocument, options);
}
export type SelectExerciseQueryHookResult = ReturnType<
  typeof useSelectExerciseQuery
>;
export type SelectExerciseLazyQueryHookResult = ReturnType<
  typeof useSelectExerciseLazyQuery
>;
export type SelectExerciseSuspenseQueryHookResult = ReturnType<
  typeof useSelectExerciseSuspenseQuery
>;
export type SelectExerciseQueryResult = Apollo.QueryResult<
  SelectExerciseQuery,
  SelectExerciseQueryVariables
>;
 ...
 * });
 */
export function useExerciseHistoryByExerciseQuery(
  baseOptions: Apollo.QueryHookOptions<
    ExerciseHistoryByExerciseQuery,
    ExerciseHistoryByExerciseQueryVariables
  > &
    (
      | { variables: ExerciseHistoryByExerciseQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    ExerciseHistoryByExerciseQuery,
    ExerciseHistoryByExerciseQueryVariables
  >(ExerciseHistoryByExerciseDocument, options);
}
export function useExerciseHistoryByExerciseLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    ExerciseHistoryByExerciseQuery,
    ExerciseHistoryByExerciseQueryVariables
  >,
...
export function useExerciseHistoryByExerciseSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    ExerciseHistoryByExerciseQuery,
    ExerciseHistoryByExerciseQueryVariables
  >,
...
export type ExerciseHistoryByExerciseQueryHookResult = ReturnType<
  typeof useExerciseHistoryByExerciseQuery
>;
export type ExerciseHistoryByExerciseLazyQueryHookResult = ReturnType<
  typeof useExerciseHistoryByExerciseLazyQuery
>;
export type ExerciseHistoryByExerciseSuspenseQueryHookResult = ReturnType<
  typeof useExerciseHistoryByExerciseSuspenseQuery
>;
export type ExerciseHistoryByExerciseQueryResult = Apollo.QueryResult<
  ExerciseHistoryByExerciseQuery,
  ExerciseHistoryByExerciseQueryVariables
>;
 ...
 * });
 */
export function useExerciseSheetQuery(
  baseOptions: Apollo.QueryHookOptions<
    ExerciseSheetQuery,
    ExerciseSheetQueryVariables
  > &
    (
      | { variables: ExerciseSheetQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ExerciseSheetQuery, ExerciseSheetQueryVariables>(
    ExerciseSheetDocument,
    options,
  );
}
export function useExerciseSheetLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    ExerciseSheetQuery,
    ExerciseSheetQueryVariables
  >,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ExerciseSheetQuery, ExerciseSheetQueryVariables>(
    ExerciseSheetDocument,
    options,
  );
}
export function useExerciseSheetSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    ExerciseSheetQuery,
    ExerciseSheetQueryVariables
  >,
  ...
  return Apollo.useSuspenseQuery<
    ExerciseSheetQuery,
    ExerciseSheetQueryVariables
  >(ExerciseSheetDocument, options);
}
export type ExerciseSheetQueryHookResult = ReturnType<
  typeof useExerciseSheetQuery
>;
export type ExerciseSheetLazyQueryHookResult = ReturnType<
  typeof useExerciseSheetLazyQuery
>;
export type ExerciseSheetSuspenseQueryHookResult = ReturnType<
  typeof useExerciseSheetSuspenseQuery
>;
export type ExerciseSheetQueryResult = Apollo.QueryResult<
  ExerciseSheetQuery,
  ExerciseSheetQueryVariables
>;
 ...
 * });
 */
export function useExerciseSheetsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    ExerciseSheetsQuery,
    ExerciseSheetsQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ExerciseSheetsQuery, ExerciseSheetsQueryVariables>(
    ExerciseSheetsDocument,
    options,
  );
}
export function useExerciseSheetsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    ExerciseSheetsQuery,
    ExerciseSheetsQueryVariables
  >,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ExerciseSheetsQuery, ExerciseSheetsQueryVariables>(
    ExerciseSheetsDocument,
    options,
  );
}
export function useExerciseSheetsSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    ExerciseSheetsQuery,
    ExerciseSheetsQueryVariables
  >,
  ...
  return Apollo.useSuspenseQuery<
    ExerciseSheetsQuery,
    ExerciseSheetsQueryVariables
  >(ExerciseSheetsDocument, options);
}
export type ExerciseSheetsQueryHookResult = ReturnType<
  typeof useExerciseSheetsQuery
>;
export type ExerciseSheetsLazyQueryHookResult = ReturnType<
  typeof useExerciseSheetsLazyQuery
>;
export type ExerciseSheetsSuspenseQueryHookResult = ReturnType<
  typeof useExerciseSheetsSuspenseQuery
>;
export type ExerciseSheetsQueryResult = Apollo.QueryResult<
  ExerciseSheetsQuery,
  ExerciseSheetsQueryVariables
>;
 ...
 * });
 */
export function useExerciseTagsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    ExerciseTagsQuery,
    ExerciseTagsQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ExerciseTagsQuery, ExerciseTagsQueryVariables>(
    ExerciseTagsDocument,
    options,
  );
}
export function useExerciseTagsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    ExerciseTagsQuery,
    ExerciseTagsQueryVariables
  >,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ExerciseTagsQuery, ExerciseTagsQueryVariables>(
    ExerciseTagsDocument,
    options,
  );
}
export function useExerciseTagsSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    ExerciseTagsQuery,
    ExerciseTagsQueryVariables
  >,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<ExerciseTagsQuery, ExerciseTagsQueryVariables>(
    ExerciseTagsDocument,
    options,
  );
}
export type ExerciseTagsQueryHookResult = ReturnType<
  typeof useExerciseTagsQuery
>;
export type ExerciseTagsLazyQueryHookResult = ReturnType<
  typeof useExerciseTagsLazyQuery
>;
export type ExerciseTagsSuspenseQueryHookResult = ReturnType<
  typeof useExerciseTagsSuspenseQuery
>;
export type ExerciseTagsQueryResult = Apollo.QueryResult<
  ExerciseTagsQuery,
  ExerciseTagsQueryVariables
>;
 ...
 * });
 */
export function useSelectExercisesQuery(
  baseOptions: Apollo.QueryHookOptions<
    SelectExercisesQuery,
    SelectExercisesQueryVariables
  > &
    (
      | { variables: SelectExercisesQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<SelectExercisesQuery, SelectExercisesQueryVariables>(
    SelectExercisesDocument,
    options,
  );
}
export function useSelectExercisesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SelectExercisesQuery,
    SelectExercisesQueryVariables
  >,
  ...
  return Apollo.useLazyQuery<
    SelectExercisesQuery,
    SelectExercisesQueryVariables
  >(SelectExercisesDocument, options);
}
export function useSelectExercisesSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    SelectExercisesQuery,
    SelectExercisesQueryVariables
  >,
...
export type SelectExercisesQueryHookResult = ReturnType<
  typeof useSelectExercisesQuery
>;
export type SelectExercisesLazyQueryHookResult = ReturnType<
  typeof useSelectExercisesLazyQuery
>;
export type SelectExercisesSuspenseQueryHookResult = ReturnType<
  typeof useSelectExercisesSuspenseQuery
>;
export type SelectExercisesQueryResult = Apollo.QueryResult<
  SelectExercisesQuery,
  SelectExercisesQueryVariables
>;
...
`;
export type ExportExcelMutationFn = Apollo.MutationFunction<
  ExportExcelMutation,
  ExportExcelMutationVariables
>;
...
export function useExportExcelMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<ExportExcelMutation, ExportExcelMutationVariables>(
    ExportExcelDocument,
    options,
  );
}
export type ExportExcelMutationHookResult = ReturnType<
  typeof useExportExcelMutation
>;
export type ExportExcelMutationResult =
  Apollo.MutationResult<ExportExcelMutation>;
export type ExportExcelMutationOptions = Apollo.BaseMutationOptions<
  ExportExcelMutation,
  ExportExcelMutationVariables
>;
 ...
 * });
 */
export function useFlatExerciseTagsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    FlatExerciseTagsQuery,
    FlatExerciseTagsQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<FlatExerciseTagsQuery, FlatExerciseTagsQueryVariables>(
    FlatExerciseTagsDocument,
    options,
  );
}
export function useFlatExerciseTagsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    FlatExerciseTagsQuery,
    FlatExerciseTagsQueryVariables
  >,
  ...
  return Apollo.useLazyQuery<
    FlatExerciseTagsQuery,
    FlatExerciseTagsQueryVariables
  >(FlatExerciseTagsDocument, options);
}
export function useFlatExerciseTagsSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    FlatExerciseTagsQuery,
    FlatExerciseTagsQueryVariables
  >,
...
export type FlatExerciseTagsQueryHookResult = ReturnType<
  typeof useFlatExerciseTagsQuery
>;
export type FlatExerciseTagsLazyQueryHookResult = ReturnType<
  typeof useFlatExerciseTagsLazyQuery
>;
export type FlatExerciseTagsSuspenseQueryHookResult = ReturnType<
  typeof useFlatExerciseTagsSuspenseQuery
>;
export type FlatExerciseTagsQueryResult = Apollo.QueryResult<
  FlatExerciseTagsQuery,
  FlatExerciseTagsQueryVariables
>;
 ...
 * });
 */
export function useFunkyPoolQuery(
  baseOptions?: Apollo.QueryHookOptions<
    FunkyPoolQuery,
    FunkyPoolQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<FunkyPoolQuery, FunkyPoolQueryVariables>(
    FunkyPoolDocument,
    options,
  );
}
export function useFunkyPoolLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    FunkyPoolQuery,
    FunkyPoolQueryVariables
  >,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<FunkyPoolQuery, FunkyPoolQueryVariables>(
    FunkyPoolDocument,
    options,
  );
}
export function useFunkyPoolSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    FunkyPoolQuery,
    FunkyPoolQueryVariables
  >,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<FunkyPoolQuery, FunkyPoolQueryVariables>(
    FunkyPoolDocument,
    options,
  );
}
export type FunkyPoolQueryHookResult = ReturnType<typeof useFunkyPoolQuery>;
export type FunkyPoolLazyQueryHookResult = ReturnType<
  typeof useFunkyPoolLazyQuery
>;
export type FunkyPoolSuspenseQueryHookResult = ReturnType<
  typeof useFunkyPoolSuspenseQuery
>;
export type FunkyPoolQueryResult = Apollo.QueryResult<
  FunkyPoolQuery,
  FunkyPoolQueryVariables
>;
 ...
 * });
 */
export function useListExcelExportsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    ListExcelExportsQuery,
    ListExcelExportsQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ListExcelExportsQuery, ListExcelExportsQueryVariables>(
    ListExcelExportsDocument,
    options,
  );
}
export function useListExcelExportsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    ListExcelExportsQuery,
    ListExcelExportsQueryVariables
  >,
  ...
  return Apollo.useLazyQuery<
    ListExcelExportsQuery,
    ListExcelExportsQueryVariables
  >(ListExcelExportsDocument, options);
}
export function useListExcelExportsSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    ListExcelExportsQuery,
    ListExcelExportsQueryVariables
  >,
...
export type ListExcelExportsQueryHookResult = ReturnType<
  typeof useListExcelExportsQuery
>;
export type ListExcelExportsLazyQueryHookResult = ReturnType<
  typeof useListExcelExportsLazyQuery
>;
export type ListExcelExportsSuspenseQueryHookResult = ReturnType<
  typeof useListExcelExportsSuspenseQuery
>;
export type ListExcelExportsQueryResult = Apollo.QueryResult<
  ListExcelExportsQuery,
  ListExcelExportsQueryVariables
>;
 ...
 * });
 */
export function useSearchExercisesQuery(
  baseOptions: Apollo.QueryHookOptions<
    SearchExercisesQuery,
    SearchExercisesQueryVariables
  > &
    (
      | { variables: SearchExercisesQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<SearchExercisesQuery, SearchExercisesQueryVariables>(
    SearchExercisesDocument,
    options,
  );
}
export function useSearchExercisesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SearchExercisesQuery,
    SearchExercisesQueryVariables
  >,
  ...
  return Apollo.useLazyQuery<
    SearchExercisesQuery,
    SearchExercisesQueryVariables
  >(SearchExercisesDocument, options);
}
export function useSearchExercisesSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    SearchExercisesQuery,
    SearchExercisesQueryVariables
  >,
...
export type SearchExercisesQueryHookResult = ReturnType<
  typeof useSearchExercisesQuery
>;
export type SearchExercisesLazyQueryHookResult = ReturnType<
  typeof useSearchExercisesLazyQuery
>;
export type SearchExercisesSuspenseQueryHookResult = ReturnType<
  typeof useSearchExercisesSuspenseQuery
>;
export type SearchExercisesQueryResult = Apollo.QueryResult<
  SearchExercisesQuery,
  SearchExercisesQueryVariables
>;
...
export const UpdateExerciseCommentDocument = gql`
  ...
  ${ExerciseCommentFragmentDoc}
`;
export type UpdateExerciseCommentMutationFn = Apollo.MutationFunction<
  UpdateExerciseCommentMutation,
  UpdateExerciseCommentMutationVariables
>;
 ...
 * });
 */
export function useUpdateExerciseCommentMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateExerciseCommentMutation,
    UpdateExerciseCommentMutationVariables
  >,
  ...
  return Apollo.useMutation<
    UpdateExerciseCommentMutation,
    UpdateExerciseCommentMutationVariables
  >(UpdateExerciseCommentDocument, options);
}
export type UpdateExerciseCommentMutationHookResult = ReturnType<
  typeof useUpdateExerciseCommentMutation
>;
export type UpdateExerciseCommentMutationResult =
  Apollo.MutationResult<UpdateExerciseCommentMutation>;
export type UpdateExerciseCommentMutationOptions = Apollo.BaseMutationOptions<
  UpdateExerciseCommentMutation,
  UpdateExerciseCommentMutationVariables
>;
...
`;
export type UpdateExerciseSheetMutationFn = Apollo.MutationFunction<
  UpdateExerciseSheetMutation,
  UpdateExerciseSheetMutationVariables
>;
 ...
 * });
 */
export function useUpdateExerciseSheetMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateExerciseSheetMutation,
    UpdateExerciseSheetMutationVariables
  >,
  ...
  return Apollo.useMutation<
    UpdateExerciseSheetMutation,
    UpdateExerciseSheetMutationVariables
  >(UpdateExerciseSheetDocument, options);
}
export type UpdateExerciseSheetMutationHookResult = ReturnType<
  typeof useUpdateExerciseSheetMutation
>;
export type UpdateExerciseSheetMutationResult =
  Apollo.MutationResult<UpdateExerciseSheetMutation>;
export type UpdateExerciseSheetMutationOptions = Apollo.BaseMutationOptions<
  UpdateExerciseSheetMutation,
  UpdateExerciseSheetMutationVariables
>;
...
`;
export type UpdateExerciseTagMutationFn = Apollo.MutationFunction<
  UpdateExerciseTagMutation,
  UpdateExerciseTagMutationVariables
>;
 ...
 * });
 */
export function useUpdateExerciseTagMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateExerciseTagMutation,
    UpdateExerciseTagMutationVariables
  >,
  ...
  return Apollo.useMutation<
    UpdateExerciseTagMutation,
    UpdateExerciseTagMutationVariables
  >(UpdateExerciseTagDocument, options);
}
export type UpdateExerciseTagMutationHookResult = ReturnType<
  typeof useUpdateExerciseTagMutation
>;
export type UpdateExerciseTagMutationResult =
  Apollo.MutationResult<UpdateExerciseTagMutation>;
export type UpdateExerciseTagMutationOptions = Apollo.BaseMutationOptions<
  UpdateExerciseTagMutation,
  UpdateExerciseTagMutationVariables
>;
 ...
 * });
 */
export function useSelectUserExercisesQuery(
  baseOptions: Apollo.QueryHookOptions<
    SelectUserExercisesQuery,
    SelectUserExercisesQueryVariables
  > &
    (
      | { variables: SelectUserExercisesQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    SelectUserExercisesQuery,
    SelectUserExercisesQueryVariables
  >(SelectUserExercisesDocument, options);
}
export function useSelectUserExercisesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SelectUserExercisesQuery,
    SelectUserExercisesQueryVariables
  >,
...
export function useSelectUserExercisesSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    SelectUserExercisesQuery,
    SelectUserExercisesQueryVariables
  >,
...
export type SelectUserExercisesQueryHookResult = ReturnType<
  typeof useSelectUserExercisesQuery
>;
export type SelectUserExercisesLazyQueryHookResult = ReturnType<
  typeof useSelectUserExercisesLazyQuery
>;
export type SelectUserExercisesSuspenseQueryHookResult = ReturnType<
  typeof useSelectUserExercisesSuspenseQuery
>;
export type SelectUserExercisesQueryResult = Apollo.QueryResult<
  SelectUserExercisesQuery,
  SelectUserExercisesQueryVariables
>;
 ...
 * });
 */
export function useSelectUserCommentsQuery(
  baseOptions: Apollo.QueryHookOptions<
    SelectUserCommentsQuery,
    SelectUserCommentsQueryVariables
  > &
    (
      | { variables: SelectUserCommentsQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    SelectUserCommentsQuery,
    SelectUserCommentsQueryVariables
  >(SelectUserCommentsDocument, options);
}
export function useSelectUserCommentsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SelectUserCommentsQuery,
    SelectUserCommentsQueryVariables
  >,
...
export function useSelectUserCommentsSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    SelectUserCommentsQuery,
    SelectUserCommentsQueryVariables
  >,
...
export type SelectUserCommentsQueryHookResult = ReturnType<
  typeof useSelectUserCommentsQuery
>;
export type SelectUserCommentsLazyQueryHookResult = ReturnType<
  typeof useSelectUserCommentsLazyQuery
>;
export type SelectUserCommentsSuspenseQueryHookResult = ReturnType<
  typeof useSelectUserCommentsSuspenseQuery
>;
export type SelectUserCommentsQueryResult = Apollo.QueryResult<
  SelectUserCommentsQuery,
  SelectUserCommentsQueryVariables
>;
...
`;
export type VoteOnDeveloperMutationFn = Apollo.MutationFunction<
  VoteOnDeveloperMutation,
  VoteOnDeveloperMutationVariables
>;
 ...
 * });
 */
export function useVoteOnDeveloperMutation(
  baseOptions?: Apollo.MutationHookOptions<
    VoteOnDeveloperMutation,
    VoteOnDeveloperMutationVariables
  >,
  ...
  return Apollo.useMutation<
    VoteOnDeveloperMutation,
    VoteOnDeveloperMutationVariables
  >(VoteOnDeveloperDocument, options);
}
export type VoteOnDeveloperMutationHookResult = ReturnType<
  typeof useVoteOnDeveloperMutation
>;
export type VoteOnDeveloperMutationResult =
  Apollo.MutationResult<VoteOnDeveloperMutation>;
export type VoteOnDeveloperMutationOptions = Apollo.BaseMutationOptions<
  VoteOnDeveloperMutation,
  VoteOnDeveloperMutationVariables
>;
