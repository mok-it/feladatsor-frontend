...
export type CreateExerciseSheetCommentMutationVariables = Exact<{
  input: CreateExerciseSheetCommentInput;
}>;


export type CreateExerciseSheetCommentMutation = { __typename: 'Mutation', createExerciseSheetComment: { __typename: 'ExerciseSheetComment', id: string, comment: string, isResolved: boolean, resolvedAt?: string | null, createdAt: string, updatedAt: string, exerciseSheetId?: string | null, exerciseSheetItemId?: string | null, exerciseOnExerciseSheetItemId?: string | null, user: { __typename: 'User', id: string, name: string, avatarUrl?: string | null } } };
...
export type DeleteExerciseSheetCommentMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type DeleteExerciseSheetCommentMutation = { __typename: 'Mutation', deleteExerciseSheetComment: boolean };
...
export type ExerciseSheetCommentsQuery = { __typename: 'Query', exerciseSheetComments: Array<{ __typename: 'ExerciseSheetComment', id: string, comment: string, isResolved: boolean, resolvedAt?: string | null, createdAt: string, updatedAt: string, exerciseSheetId?: string | null, exerciseSheetItemId?: string | null, exerciseOnExerciseSheetItemId?: string | null, user: { __typename: 'User', id: string, name: string, avatarUrl?: string | null } }> };
...
export type ExerciseSheetCommentFragment = { __typename: 'ExerciseSheetComment', id: string, comment: string, isResolved: boolean, resolvedAt?: string | null, createdAt: string, updatedAt: string, exerciseSheetId?: string | null, exerciseSheetItemId?: string | null, exerciseOnExerciseSheetItemId?: string | null, user: { __typename: 'User', id: string, name: string, avatarUrl?: string | null } };
...
export type ResolveExerciseSheetCommentMutationVariables = Exact<{
  id: Scalars['ID']['input'];
  notes?: InputMaybe<Scalars['String']['input']>;
}>;


export type ResolveExerciseSheetCommentMutation = { __typename: 'Mutation', resolveExerciseSheetComment: { __typename: 'ExerciseSheetComment', id: string, comment: string, isResolved: boolean, resolvedAt?: string | null, createdAt: string, updatedAt: string, exerciseSheetId?: string | null, exerciseSheetItemId?: string | null, exerciseOnExerciseSheetItemId?: string | null, user: { __typename: 'User', id: string, name: string, avatarUrl?: string | null } } };
...
export const ExerciseSheetCommentFragmentDoc = gql`
    fragment ExerciseSheetComment on ExerciseSheetComment {
  id
  comment
  user {
    id
...
export const CreateExerciseSheetCommentDocument = gql`
    mutation CreateExerciseSheetComment($input: CreateExerciseSheetCommentInput!) {
  createExerciseSheetComment(input: $input) {
    ...ExerciseSheetComment
  }
}
    ${ExerciseSheetCommentFragmentDoc}`;
export type CreateExerciseSheetCommentMutationFn = Apollo.MutationFunction<CreateExerciseSheetCommentMutation, CreateExerciseSheetCommentMutationVariables>;

/**
 * __useCreateExerciseSheetCommentMutation__
 *
 * To run a mutation, you first call `useCreateExerciseSheetCommentMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateExerciseSheetCommentMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createExerciseSheetCommentMutation, { data, loading, error }] = useCreateExerciseSheetCommentMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreateExerciseSheetCommentMutation(baseOptions?: Apollo.MutationHookOptions<CreateExerciseSheetCommentMutation, CreateExerciseSheetCommentMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateExerciseSheetCommentMutation, CreateExerciseSheetCommentMutationVariables>(CreateExerciseSheetCommentDocument, options);
      }
export type CreateExerciseSheetCommentMutationHookResult = ReturnType<typeof useCreateExerciseSheetCommentMutation>;
export type CreateExerciseSheetCommentMutationResult = Apollo.MutationResult<CreateExerciseSheetCommentMutation>;
export type CreateExerciseSheetCommentMutationOptions = Apollo.BaseMutationOptions<CreateExerciseSheetCommentMutation, CreateExerciseSheetCommentMutationVariables>;
...
export const DeleteExerciseSheetCommentDocument = gql`
    mutation DeleteExerciseSheetComment($id: ID!) {
  deleteExerciseSheetComment(id: $id)
}
    `;
export type DeleteExerciseSheetCommentMutationFn = Apollo.MutationFunction<DeleteExerciseSheetCommentMutation, DeleteExerciseSheetCommentMutationVariables>;

/**
 * __useDeleteExerciseSheetCommentMutation__
 *
 * To run a mutation, you first call `useDeleteExerciseSheetCommentMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteExerciseSheetCommentMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [deleteExerciseSheetCommentMutation, { data, loading, error }] = useDeleteExerciseSheetCommentMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useDeleteExerciseSheetCommentMutation(baseOptions?: Apollo.MutationHookOptions<DeleteExerciseSheetCommentMutation, DeleteExerciseSheetCommentMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteExerciseSheetCommentMutation, DeleteExerciseSheetCommentMutationVariables>(DeleteExerciseSheetCommentDocument, options);
      }
export type DeleteExerciseSheetCommentMutationHookResult = ReturnType<typeof useDeleteExerciseSheetCommentMutation>;
export type DeleteExerciseSheetCommentMutationResult = Apollo.MutationResult<DeleteExerciseSheetCommentMutation>;
export type DeleteExerciseSheetCommentMutationOptions = Apollo.BaseMutationOptions<DeleteExerciseSheetCommentMutation, DeleteExerciseSheetCommentMutationVariables>;
...
export const ExerciseSheetCommentsDocument = gql`
    query ExerciseSheetComments($sheetId: ID!) {
  exerciseSheetComments(sheetId: $sheetId) {
    ...ExerciseSheetComment
  }
}
    ${ExerciseSheetCommentFragmentDoc}`;
...
/**
 * __useExerciseSheetCommentsQuery__
 *
 * To run a query within a React component, call `useExerciseSheetCommentsQuery` and pass it any options that fit your needs.
 * When your component renders, `useExerciseSheetCommentsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useExerciseSheetCommentsQuery({
 *   variables: {
 *      sheetId: // value for 'sheetId'
 *   },
 * });
 */
export function useExerciseSheetCommentsQuery(baseOptions: Apollo.QueryHookOptions<ExerciseSheetCommentsQuery, ExerciseSheetCommentsQueryVariables> & ({ variables: ExerciseSheetCommentsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ExerciseSheetCommentsQuery, ExerciseSheetCommentsQueryVariables>(ExerciseSheetCommentsDocument, options);
      }
export function useExerciseSheetCommentsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ExerciseSheetCommentsQuery, ExerciseSheetCommentsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ExerciseSheetCommentsQuery, ExerciseSheetCommentsQueryVariables>(ExerciseSheetCommentsDocument, options);
        }
export function useExerciseSheetCommentsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<ExerciseSheetCommentsQuery, ExerciseSheetCommentsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<ExerciseSheetCommentsQuery, ExerciseSheetCommentsQueryVariables>(ExerciseSheetCommentsDocument, options);
        }
export type ExerciseSheetCommentsQueryHookResult = ReturnType<typeof useExerciseSheetCommentsQuery>;
export type ExerciseSheetCommentsLazyQueryHookResult = ReturnType<typeof useExerciseSheetCommentsLazyQuery>;
export type ExerciseSheetCommentsSuspenseQueryHookResult = ReturnType<typeof useExerciseSheetCommentsSuspenseQuery>;
export type ExerciseSheetCommentsQueryResult = Apollo.QueryResult<ExerciseSheetCommentsQuery, ExerciseSheetCommentsQueryVariables>;
...
export const ResolveExerciseSheetCommentDocument = gql`
    mutation ResolveExerciseSheetComment($id: ID!, $notes: String) {
  resolveExerciseSheetComment(id: $id, notes: $notes) {
    ...ExerciseSheetComment
  }
}
    ${ExerciseSheetCommentFragmentDoc}`;
export type ResolveExerciseSheetCommentMutationFn = Apollo.MutationFunction<ResolveExerciseSheetCommentMutation, ResolveExerciseSheetCommentMutationVariables>;

/**
 * __useResolveExerciseSheetCommentMutation__
 *
 * To run a mutation, you first call `useResolveExerciseSheetCommentMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useResolveExerciseSheetCommentMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [resolveExerciseSheetCommentMutation, { data, loading, error }] = useResolveExerciseSheetCommentMutation({
 *   variables: {
 *      id: // value for 'id'
 ...
 * });
 */
export function useResolveExerciseSheetCommentMutation(baseOptions?: Apollo.MutationHookOptions<ResolveExerciseSheetCommentMutation, ResolveExerciseSheetCommentMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ResolveExerciseSheetCommentMutation, ResolveExerciseSheetCommentMutationVariables>(ResolveExerciseSheetCommentDocument, options);
      }
export type ResolveExerciseSheetCommentMutationHookResult = ReturnType<typeof useResolveExerciseSheetCommentMutation>;
export type ResolveExerciseSheetCommentMutationResult = Apollo.MutationResult<ResolveExerciseSheetCommentMutation>;
export type ResolveExerciseSheetCommentMutationOptions = Apollo.BaseMutationOptions<ResolveExerciseSheetCommentMutation, ResolveExerciseSheetCommentMutationVariables>;
